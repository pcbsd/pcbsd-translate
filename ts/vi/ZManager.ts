...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Áp dụng thay đổi đệ quy cho tất cả con cháu</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Thêm bất động sản sử dụng</translation>
    </message>
    <message>
        <source>...</source>
        <translation type="unfinished">...</translation>
    ...
    <message>
        ...
        <translation type="unfinished">Loại bỏ tài sản sử dụng</translation>
    </message>
    <message>
        <source>Inherit from parent</source>
        <translation type="unfinished">Kế thừa từ cha mẹ</translation>
    </message>
    <message>
        <source>Revert changes</source>
        <translation type="unfinished">trở lại thay đổi</translation>
    </message>
    <message>
...
discard, noallow, restricted, and passthrough. For a description of these values, see ACL Properties.</source>
        <translation type="unfinished">Kiểm soát cách mục ACL được thừa hưởng khi các tập tin và thư mục được tạo ra. Các giá trị
...
these values, see ACL Properties.</source>
        <translation type="unfinished">Kiểm soát như thế nào một ACL được sửa đổi trong một hoạt động chmod.
...
similar utilities.</source>
        <translation type="unfinished">Điều khiển thời gian truy cập cho các tập tin được cập nhật khi chúng được đọc.
...
physical pool size, quotas, reservations, and other datasets within the pool.</source>
        <translation type="unfinished">Thuộc tính chỉ đọc xác định số lượng không gian đĩa có sẵn cho một bộ dữ liệu
...
inherited characteristics.</source>
        <translation type="unfinished">Nếu tài sản này được thiết lập để tắt, hệ thống tập tin không thể được gắn kết,
...
checksums is NOT a recommended practice.</source>
        <translation type="unfinished">Kiểm soát kiểm tra được sử dụng để xác minh tính toàn vẹn dữ liệu.
...
the compression property.</source>
        <translation type="unfinished">Thuộc tính chỉ đọc xác định tỉ lệ nén đạt được cho một bộ dữ liệu,
...
on an existing file system only affects newly written data.</source>
        <translation type="unfinished">Đặt số lượng bản sao của dữ liệu người dùng trên hệ thống tập tin. Các bản sao
...
trên một hệ thống tập tin hiện có chỉ ảnh hưởng đến dữ liệu mới bằng văn bản.</translation>
    ...
    <message>
        ...
        <translation type="unfinished">Thuộc tính chỉ đọc để nhận dạng ngày tháng và thời gian mà một bộ dữ liệu được tạo ra.</translation>
    </message>
    <message>
...
are identical.</source>
        <translation type="unfinished">Cấu hình pc cho một tập dữ liệu. Giá trị mặc ​​định là tắt.
...
giống hệt nhau.</translation>
    ...
    <message>
        ...
        <translation type="unfinished">Tài sản thiết bị hiện đang không được hỗ trợ trên FreeBSD.</translation>
    </message>
    <message>
        <source>Controls whether processes can be executed from within this file
system. The default value is on.</source>
        <translation type="unfinished">Điều khiển quá trình có thể được thực hiện từ bên trong tập tin này
...
is currently mounted.</source>
        <translation type="unfinished">Thuộc tính chỉ đọc cho biết có một hệ thống tập tin, nhân bản, hoặc ảnh chụp
...
In addition, any shared file systems are unshared and shared in the new location.</source>
        <translation type="unfinished">Kiểm soát các điểm gắn kết sử dụng cho hệ thống tập tin này. Khi bất động sản láp
...
metadata is cached.</source>
        <translation type="unfinished">Kiểm soát những gì được lưu trữ trong bộ nhớ cache chính (ARC). Giá trị có thể là tất cả,
...
Non-cloned file systems have an origin of none.</source>
        <translation type="unfinished">Thuộc tính chỉ đọc các file hệ thống nhân bản vô tính hoặc khối lượng xác định
...
override the ancestor&apos;s quota, but rather imposes an additional limit.</source>
        <translation type="unfinished">Giới hạn số lượng không gian đĩa một bộ dữ liệu và các hậu duệ của nó có thể tiêu thụ.
...
no modifications can be made.</source>
        <translation type="unfinished">Kiểm soát xem một bộ dữ liệu có thể được sửa đổi. Khi thiết lập trên,
...
512 and less than or equal to 128 Kbytes.</source>
        <translation type="unfinished">Quy định cụ thể một kích thước khối đề nghị cho các tập tin trong hệ thống tập tin.
...
pool.</source>
        <translation type="unfinished">Thuộc tính chỉ đọc xác định số lượng dữ liệu truy cập bằng một
...
not include disk space used by descendents, such as snapshots and clones.</source>
        <translation type="unfinished">Thiết lập dung lượng ổ đĩa mà một bộ dữ liệu có thể tiêu thụ. Này sở hữu
...
referenced bytes in the dataset.</source>
        <translation type="unfinished">Đặt số tiền tối thiểu của không gian đĩa được đảm bảo để một bộ dữ liệu, không
...
dataset&apos;s quotas and reservations.</source>
        <translation type="unfinished">Đặt số tiền tối thiểu của không gian đĩa được đảm bảo để một bộ dữ liệu và con cháu của nó.
...
neither user data nor metadata is cached. If set to metadata, only metadata is cached.</source>
        <translation type="unfinished">Kiểm soát những gì được lưu trữ trong bộ nhớ cache thứ cấp (L2ARC). Giá trị có thể là tất cả, không có,
...
không dữ liệu người dùng cũng không siêu dữ liệu được lưu trữ. Nếu thiết lập siêu dữ liệu, chỉ có siêu dữ liệu được lưu trữ.</translation>
    ...
    <message>
        ...
        <translation type="unfinished">Kiểm soát cho dù các bit setuid được vinh danh trong một hệ thống tập tin.</translation>
    </message>
    <message>
...
options equivalent to the contents of this property.</source>
        <translation type="unfinished">Kiểm soát cho dù một hệ thống tập tin có sẵn trên NFS và những gì
...
tùy chọn tương ứng với nội dung của khách sạn này.</translation>
    ...
    <message>
        ...
        <translation type="unfinished">Tài sản sharesmb hiện không có tác dụng trên FreeBSD.</translation>
    </message>
    <message>
        <source>Controls whether the .zfs directory is hidden or visible in the root of the file system.</source>
        <translation type="unfinished">Điều khiển các thư mục zfs. Là ẩn hay nhìn thấy trong thư mục gốc của hệ thống tập tin.</translation>
    </message>
    <message>
        <source>Read-only property that identifies the dataset type as filesystem (file system or clone), volume, or snapshot.</source>
        <translation type="unfinished">Thuộc tính chỉ đọc để nhận dạng các loại dữ liệu như hệ thống tập tin (file hệ thống hoặc bản sao), khối lượng, hoặc ảnh chụp.</translation>
    </message>
    <message>
        <source>Read-only property that identifies the amount of disk space consumed by a dataset and all its descendents.</source>
        <translation type="unfinished">Thuộc tính chỉ đọc xác định số lượng không gian đĩa được tiêu thụ bởi một bộ dữ liệu và tất cả con cháu của nó.</translation>
    </message>
    <message>
...
were destroyed.</source>
        <translation type="unfinished">Thuộc tính chỉ đọc xác định số lượng không gian đĩa được sử dụng bởi
...
removed.</source>
        <translation type="unfinished">Thuộc tính chỉ đọc xác định số lượng không gian đĩa được sử dụng bởi một
...
space can be shared by multiple snapshots.</source>
        <translation type="unfinished">Thuộc tính chỉ đọc xác định số lượng không gian đĩa được tiêu thụ
...
from the supported software release.</source>
        <translation type="unfinished">Xác định các phiên bản trên đĩa của một hệ thống tập tin, đó là độc lập với
...
từ việc phát hành phần mềm hỗ trợ.</translation>
    ...
    <message>
        ...
        <translation type="unfinished">Đối với khối lượng, chỉ định kích thước hợp lý của khối lượng.</translation>
    </message>
    <message>
        <source>For volumes, specifies the block size of the volume.</source>
        <translation type="unfinished">Đối với khối lượng, xác định kích thước khối của khối lượng.</translation>
    </message>
    <message>
        <source>Indicates whether a dataset has been added to a jail.</source>
        <translation type="unfinished">Biết xem một bộ dữ liệu đã được thêm vào một nhà tù.</translation>
    </message>
    <message>
        <source>This property is not supported on FreeBSD.</source>
        <translation type="unfinished">Khách sạn này không được hỗ trợ trên FreeBSD.</translation>
    </message>
    <message>
        <source>The file system is marked to be destroyed after unmount.</source>
        <translation type="unfinished">Hệ thống tập tin được đánh dấu để bị phá hủy sau khi tháo gắn.</translation>
    </message>
    <message>
        <source>The compression ratio achieved for the referenced space of this
dataset, expressed as a multiplier.</source>
        <translation type="unfinished">Tỉ lệ nén đạt được cho các không gian tham chiếu của
...
previous snapshot.</source>
        <translation type="unfinished">Số lượng không gian tham chiếu bằng văn bản cho bộ dữ liệu này kể từ khi
ảnh chụp trước đây.</translation>
    </message>
    <message>
        <source>This property is set to the number of user holds on this snapshot.
</source>
        <translation type="unfinished">Khách sạn này được thiết lập để số lượng người sử dụng nắm giữ trên ảnh chụp này.
</translation>
    </message>
    <message>
...
for global pool throughput and efficient use of resources.</source>
        <translation type="unfinished">Cung cấp một gợi ý cho ZFS về xử lý yêu cầu đồng bộ trong này
...
disabled  Disables synchronous requests. File system transactions
        ...
        <translation type="unfinished">Kiểm soát hành vi của các yêu cầu đồng bộ (ví dụ fsync (2),
...
lựa chọn khi các rủi ro được hiểu.</translation>
    ...
    <message>
        ...
        <translation type="unfinished">Khách sạn này không thể thay đổi sau khi hệ thống được tạo ra.</translation>
    </message>
    <message>
        <source>User Property</source>
        <translation type="unfinished">Sử dụng tài sản</translation>
    </message>
    <message>
        <source>Unknown property or information not available.
Read ZFS manual for more information.</source>
        <translation type="unfinished">Tài sản không rõ hoặc thông tin không có sẵn
.Đọc ZFS dẫn để biết thêm thông tin.</translation>
    </message>
    <message>
        <source>[Invalid]</source>
        <translation type="unfinished">[Hợp lệ]</translation>
    </message>
    <message>
        <source>[Inherit]</source>
        <translation type="unfinished">[Kế thừa]</translation>
    </message>
    <message>
        <source>[Added]</source>
    ...
    <message>
        <source>User property</source>
        <translation type="unfinished">Bất động sản sử dụng</translation>
    </message>
    <message>
        <source>Device Menu</source>
        <translation type="unfinished">Thiết bị đơn</translation>
    </message>
    <message>
        <source>Add new user property</source>
        <translation type="unfinished">Thêm tài sản người dùng mới</translation>
    </message>
    <message>
        <source>Delete user property</source>
        <translation type="unfinished">Xóa thuộc tính người dùng</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Thiết bị để gắn kết:</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Gắn kết vị trí:</translation>
    </message>
    <message>
        <source>...</source>
        <translation type="unfinished">...</translation>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Tên hồ:</translation>
    </message>
    <message>
        <source>Do not mount any filesystems</source>
        <translation type="unfinished">Không gắn kết bất kỳ hệ thống tập tin</translation>
    </message>
    <message>
        <source>Read only pool</source>
        <translation type="unfinished">Chỉ đọc hồ bơi</translation>
    </message>
    <message>
        <source>Import options:</source>
        <translation type="unfinished">Tùy chọn nhập khẩu:</translation>
    </message>
    <message>
        <source>Mount with alternative root:</source>
        <translation type="unfinished">Gắn kết với gốc thay thế:</translation>
    </message>
    <message>
        <source>Mount all filesystems automatically</source>
        <translation type="unfinished">Mount with the original thay thế:</translation>
    </message>
    <message>
        <source>Mounting behavior:</source>
        <translation type="unfinished">Lắp hành vi:</translation>
    </message>
    <message>
        <source>Force operation if error (use with caution)</source>
        <translation type="unfinished">Hoạt động vũ lực nếu lỗi (sử dụng một cách thận trọng)</translation>
    </message>
</context>
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Chọn</translation>
    </message>
    <message>
        <source>Pool name:</source>
        <translation type="unfinished">Tên hồ:</translation>
    ...
    <message>
        ...
        <translation type="unfinished">Loại cấu hình:</translation>
    </message>
    <message>
        <source>Striped</source>
        <translation type="unfinished">Sọc</translation>
    </message>
    <message>
        <source>Mirror</source>
        <translation type="unfinished">Gương</translation>
    </message>
    <message>
        <source>Raid-Z (single parity)</source>
        <translation type="unfinished">Raid-Z (chẵn lẻ duy nhất)</translation>
    </message>
    <message>
        <source>Raid-Z2 (double parity)</source>
        <translation type="unfinished">Raid-Z2 (chẵn lẻ đôi)</translation>
    </message>
    <message>
        <source>Raid-Z3 (triple parity)</source>
        <translation type="unfinished">Raid-Z3 (chẵn lẻ ba)</translation>
    </message>
    <message>
        <source>Cache</source>
        <translation type="unfinished">Bộ nhớ cache</translation>
    </message>
    <message>
        <source>Log</source>
    ...
    <message>
        <source>Spare</source>
        <translation type="unfinished">tùng</translation>
    </message>
    <message>
        <source>Error Description Here</source>
        <translation type="unfinished">Lỗi Mô tả đây</translation>
    </message>
    <message>
        <source>Must provide a valid pool name</source>
        <translation type="unfinished">Phải cung cấp tên hồ bơi hợp lệ</translation>
    </message>
    <message>
        <source>Must select exactly %1 devices</source>
        <translation type="unfinished">Phải chọn chính xác %1 thiết bị</translation>
    </message>
    <message>
        <source>Must select at least one device</source>
        <translation type="unfinished">Phải chọn ít nhất một thiết bị</translation>
    </message>
</context>
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Thêm phân vùng</translation>
    </message>
    <message>
        <source>Add new slice/partition</source>
        <translation type="unfinished">Thêm mới lát/phân vùng</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Lớn nhất khối miễn phí có sẵn:</translation>
    </message>
    <message>
        <source>Total Size:</source>
        <translation type="unfinished">Tổng số lượng:</translation>
    </message>
    <message>
        <source>Current layout:</source>
        <translation type="unfinished">Bố trí hiện tại:</translation>
    </message>
    <message>
        <source>Designation</source>
        <translation type="unfinished">định</translation>
    </message>
    <message>
        <source>Start Sector</source>
        <translation type="unfinished">Bắt đầu ngành</translation>
    </message>
    <message>
        <source>Sector Count</source>
        <translation type="unfinished">Lượt ngành</translation>
    </message>
    <message>
        <source>Size</source>
    ...
    <message>
        ...
        <translation type="unfinished">Kích thước phân vùng mới:</translation>
    </message>
    <message>
        <source>bytes</source>
    ...
    <message>
        ...
        <translation type="unfinished">Kiểu phân vùng:</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Tạo và khởi tạo một hệ thống tập tin mới</translation>
    </message>
    <message>
        <source>** FREE **</source>
    ...
    <message>
        ...
        <translation type="unfinished">Không có không gian miễn phí!</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Sửa Pool tính</translation>
    </message>
    <message>
        <source>Property</source>
        <translation type="unfinished"></translation>
    ...
    <message>
        ...
        <translation type="unfinished">Tổng kích thước của vùng lưu trữ.</translation>
    </message>
    <message>
        <source>Percentage of pool space used.</source>
        <translation type="unfinished">Tỷ lệ phần trăm của không gian hồ bơi sử dụng.</translation>
    </message>
    <message>
...
this may be overridden using an explicit setting.</source>
        <translation type="unfinished">Thư mục gốc thay thế. Nếu được thiết lập, thư mục này được thêm vào phía trước để bất kỳ
...
điều này có thể được ghi đè bằng cách sử dụng một thiết lập rõ ràng.</translation>
    ...
    <message>
        ...
        <translation type="unfinished">Sức khỏe hiện tại của hồ bơi.</translation>
    </message>
    <message>
        <source>A unique identifier for the pool.</source>
        <translation type="unfinished">Một định danh duy nhất cho hồ bơi.</translation>
    </message>
    <message>
...
&quot;zpool upgrade -v&quot;.</source>
        <translation type="unfinished">Trên đĩa phiên bản hiện tại của hồ bơi. Điều này có thể được tăng lên, nhưng
...
programs.</source>
        <translation type="unfinished">Xác định các dữ liệu khả năng khởi động mặc định cho các hồ bơi gốc.
...
information on ZFS delegated administration.</source>
        <translation type="unfinished">Điều khiển một người dùng không có đặc quyền được cấp quyền truy cập dựa trên
...
column name, &quot;replace&quot;.</source>
        <translation type="unfinished">Kiểm soát thay thế thiết bị tự động. Nếu thiết lập để &quot;tắt&quot;, thiết bị
...
the default location.</source>
        <translation type="unfinished">Kiểm soát vị trí của nơi cấu hình hồ bơi được lưu trữ.
...
default value is off.</source>
        <translation type="unfinished">Điều khiển nếu thông tin về bức ảnh chụp liên quan với điều này
...
name, expand.</source>
        <translation type="unfinished">Điều khiển mở rộng hồ bơi tự động khi LUN cơ bản được trồng
...
0.</source>
        <translation type="unfinished">Ngưỡng cho số lượng bản sao khối như trên. Nếu tham chiếu
...
of the deduplication feature.</source>
        <translation type="unfinished">Tỷ lệ pc chỉ định cho một hồ bơi, thể hiện như một số nhân.
...
các tính năng chống trùng lắp.</translation>
    ...
    <message>
        ...
        <translation type="unfinished">Số lượng các khối trong hồ bơi mà không được phân bổ.</translation>
    </message>
    <message>
        <source>Amount of storage space within the pool that has been physically allocated.</source>
        <translation type="unfinished">Số lượng không gian lưu trữ trong hồ bơi mà đã được phân bổ về thể chất.</translation>
    </message>
    <message>
...
following restrictions:
  ...
  *   To write to a read-only pool, a export and import of the pool
      is required.
        ...
        <translation type="unfinished">Nếu thiết lập trên, hồ bơi sẽ được nhập khẩu trong chế độ chỉ đọc với
hạn chế sau đây:
...
được yêu cầu.
    ...
    <message>
        ...
        <translation type="unfinished">Một bình luận chuỗi tùy ý thiết lập bởi người quản trị.</translation>
    </message>
    <message>
        <source>This property has currently no value on FreeBSD.</source>
        <translation type="unfinished">Khách sạn này hiện không có giá trị FreeBSD.</translation>
    </message>
</context>
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Hệ thống tập tin mới</translation>
    </message>
    <message>
        <source>Name:</source>
    ...
    <message>
        ...
        <translation type="unfinished">Tính ghi đè lên vào thời điểm sáng tạo:</translation>
    </message>
    <message>
        <source>Prevent auto mount (canmount=noauto)</source>
        <translation type="unfinished">Ngăn chặn tự động mount (canmount = tự động)</translation>
    </message>
    <message>
        <source>Mountpoint</source>
        <translation type="unfinished">điểm láp</translation>
    </message>
    <message>
        <source>none</source>
    ...
    <message>
        ...
        <translation type="unfinished">di sản</translation>
    </message>
    <message>
        <source>[path]</source>
    ...
    <message>
        ...
        <translation type="unfinished">Lực lượng UTF-8 chỉ (utf8only = trên)</translation>
    </message>
    <message>
        <source>Unicode normalization =</source>
        <translation type="unfinished">Bình thường hóa unicode =</translation>
    </message>
    <message>
        <source>formD</source>
        <translation type="unfinished">hìnhD</translation>
    </message>
    <message>
        <source>formKCF</source>
        <translation type="unfinished">hìnhKCF</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Chống trùng lặp (dedup = trên)</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        <source>Disks</source>
        <translation type="unfinished">đĩa</translation>
    </message>
    <message>
        <source>Device</source>
        <translation type="unfinished">thiết bị</translation>
    ...
    <message>
        <source>State</source>
        <translation type="unfinished">Nhà nước</translation>
    </message>
    <message>
    ...
    <message>
        <source>Pool Name</source>
        <translation type="unfinished">Tên Pool</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Lỗi rõ ràng</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">ZFS hệ tập tin</translation>
    </message>
    <message>
        <source>Filesystems</source>
        <translation type="unfinished">hệ tập tin</translation>
    </message>
    <message>
        <source>Status</source>
        <translation type="unfinished">Tình trạng</translation>
    ...
    <message>
        ...
        <translation type="unfinished">Không pools sẵn có, kích chuột phải để tạo ra một cái mới ...</translation>
    </message>
    <message>
        <source> (No media in drive)</source>
        <translation type="unfinished">(Không có phương tiện truyền thông trong ổ đĩa)</translation>
    </message>
    <message>
        <source>Avaliable</source>
        <translation type="unfinished">Sẵn</translation>
    </message>
    <message>
        <source>No disk</source>
        <translation type="unfinished">không có đĩa</translation>
    </message>
    <message>
        <source>ZPool: </source>
    ...
    <message>
        ...
        <translation type="unfinished">Cắt lát</translation>
    </message>
    <message>
        <source>Mounted: </source>
        <translation type="unfinished">gắn kết:</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">không có dán</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">(Xuất khẩu)
</translation>
    </message>
    <message>
        <source>(Destroyed)
</source>
        <translation type="unfinished">(bị phá hủy)
</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Bị suy thoái</translation>
    </message>
    <message>
        <source>Faulted</source>
        <translation type="unfinished">bị sự cố</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Tạo ra hồ bơi mới</translation>
    </message>
    <message>
        <source>Rename pool</source>
        <translation type="unfinished">đổi tên hồ bơi</translation>
    </message>
    <message>
        <source>Destroy pool</source>
        <translation type="unfinished">Tiêu diệt hồ bơi</translation>
    </message>
    <message>
        <source>Add devices...</source>
        <translation type="unfinished">Thêm vào thiết bị...</translation>
    </message>
    <message>
        <source>Add log devices...</source>
        <translation type="unfinished">Thêm vào thiết bị ghi...</translation>
    </message>
    <message>
        <source>Add cache devices...</source>
        <translation type="unfinished">Thêm vào các thiết bị bộ nhớ cache...</translation>
    </message>
    <message>
        <source>Add spare devices...</source>
        <translation type="unfinished">Thêm vào các thiết bị phụ tùng...</translation>
    </message>
    <message>
        <source>Scrub</source>
        <translation type="unfinished">Chà</translation>
    </message>
    <message>
        <source>Export pool</source>
        <translation type="unfinished">Hồ bơi xuất khẩu</translation>
    </message>
    <message>
        <source>Import pool</source>
        <translation type="unfinished">Hồ bơi nhập khẩu</translation>
    </message>
    <message>
        <source>Recover destroyed pool</source>
        <translation type="unfinished">Phục hồi hồ bơi bị phá hủy</translation>
    </message>
    <message>
        <source>Properties...</source>
        <translation type="unfinished">Bất động sản...</translation>
    </message>
    <message>
        <source>Attach (mirror) device...</source>
        <translation type="unfinished">Đính kèm (gương) thiết bị...</translation>
    </message>
    <message>
        <source>Detach from mirror</source>
        <translation type="unfinished">Tách từ gương</translation>
    </message>
    <message>
        <source>Take offline</source>
        <translation type="unfinished">Hãy ẩn</translation>
    </message>
    <message>
        <source>Bring online</source>
        <translation type="unfinished">Mang lại trực tuyến</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">zpool đơn</translation>
    </message>
    <message>
        <source>Device Menu</source>
        <translation type="unfinished">Thiết bị đơn</translation>
    ...
    <message>
        ...
        <translation type="unfinished">Tháo gắn kết</translation>
    </message>
    <message>
        <source>Mount</source>
        <translation type="unfinished">Gắn kết</translation>
    ...
    <message>
        ...
        <translation type="unfinished">Tạo ra bảng phân vùng MBR</translation>
    </message>
    <message>
        <source>Create GPT partition table</source>
        <translation type="unfinished">Tạo ra bảng phân vùng</translation>
    </message>
    <message>
        <source>Create BSD partition table</source>
        <translation type="unfinished">Tạo ra bảng phân vùng BSD</translation>
    </message>
    <message>
        <source>Delete Partition Table</source>
        <translation type="unfinished">Xóa bảng phân vùng</translation>
    </message>
    <message>
        <source>Add new slice</source>
        <translation type="unfinished">Thêm vào slice mới</translation>
    </message>
    <message>
        <source>Add new partition</source>
        <translation type="unfinished">Thêm vào phân vùng mới</translation>
    </message>
    <message>
        <source>Destroy this slice</source>
        <translation type="unfinished">Tiêu diệt mảnh đất này</translation>
    </message>
    <message>
        <source>Destroy this partition</source>
        <translation type="unfinished">Tiêu diệt phân vùng này</translation>
    </message>
    <message>
...
OK to destroy the slice/partition?</source>
        <translation type="unfinished">Hoạt động này không thể được hoàn tác.
OK để tiêu diệt các slice / phân vùng?</translation>
    ...
    <message>
        ...
        <translation type="unfinished">Tạo zpool mới</translation>
    </message>
    <message>
        <source>Important information</source>
        <translation type="unfinished">Thông tin quan trọng</translation>
    </message>
    <message>
        ...
        <translation type="unfinished">Hồ bơi được nhập khẩu trong chế độ chỉ đọc, do đó cố gắng để tiêu diệt các hồ bơi sẽ rời khỏi hồ bơi trong nhà nước đó là khi nhập khẩu, không nhất thiết phải tiêu huỷ.</translation>
    </message>
    <message>
        <source>Attach mirror devices to </source>
        <translation type="unfinished">Đính kèm các thiết bị gương để</translation>
    </message>
    <message>
        ...
        <translation type="unfinished">Hồ bơi được nhập khẩu trong chế độ chỉ đọc, do đó cố gắng để xuất khẩu các hồ bơi sẽ rời khỏi hồ bơi trong nhà nước đó là khi nhập khẩu, không nhất thiết phải xuất khẩu.</translation>
    </message>
    <message>
        <source>Recover destroyed pool as...</source>
        <translation type="unfinished">Phục hồi hồ bơi bị phá hủy như...</translation>
    </message>
    <message>
        <source>Import pool as...</source>
        <translation type="unfinished">Hồ bơi nhập khẩu theo...</translation>
    </message>
    <message>
...
Proceed with recovery?</source>
        <translation type="unfinished">Hồ bơi này đã bị phá hủy, và các ổ đĩa có thể được tái sử dụng. Cố gắng phục hồi sẽ tiêu diệt bất kỳ dữ liệu mới mà có thể đã được lưu trữ trong các thiết bị đã được tái sử dụng và không thể phục hồi.
 Tiến hành thu hồi?</translation>
    </message>
    <message>
        <source>The pool was imported in read-only mode, it cannot be renamed.</source>
        <translation type="unfinished">Hồ bơi được nhập khẩu trong chế độ chỉ đọc, nó không thể được đổi tên thành.</translation>
    </message>
    <message>
        <source>Add more devices to zpool</source>
        <translation type="unfinished">Bổ sung thêm thiết bị để zpool</translation>
    </message>
    <message>
        <source>Add log devices to zpool</source>
        <translation type="unfinished">Thêm vào các thiết bị đăng nhập để zpool</translation>
    </message>
    <message>
        <source>Add cache devices to zpool</source>
        <translation type="unfinished">Thêm vào các thiết bị bộ nhớ cache để zpool</translation>
    </message>
    <message>
        <source>Add spare devices to zpool</source>
        <translation type="unfinished">Thêm vào các thiết bị phụ tùng để zpool</translation>
    </message>
    <message>
        <source>[Mounted]</source>
        <translation type="unfinished">[Được lắp]</translation>
    </message>
    <message>
        <source>[Not Mounted]</source>
        <translation type="unfinished">[Không Được lắp]</translation>
    </message>
    <message>
        <source> of </source>
        <translation type="unfinished">của</translation>
    </message>
    <message>
        <source>Rename dataset</source>
        <translation type="unfinished">đổi tên bộ dữ liệu</translation>
    </message>
    <message>
        <source>Create new dataset</source>
        <translation type="unfinished">Tạo bộ dữ liệu mới</translation>
    </message>
    <message>
        <source>Create a clone dataset</source>
        <translation type="unfinished">Tạo ra một bản sao dữ liệu</translation>
    </message>
    <message>
        <source>Destroy dataset</source>
        <translation type="unfinished">Tiêu diệt dữ liệu</translation>
    </message>
    <message>
        <source>Promote filesystem</source>
        <translation type="unfinished">Thúc đẩy hệ thống tập tin</translation>
    </message>
    <message>
        <source>Take a snapshot</source>
        <translation type="unfinished">Có một bản chụp</translation>
    </message>
    <message>
        <source>Destroy snapshot</source>
        <translation type="unfinished">tiêu diệt ảnh chụp</translation>
    </message>
    <message>
        <source>Rollback to this snapshot</source>
        <translation type="unfinished">Rollback đến ảnh chụp này</translation>
    </message>
    <message>
        <source>Edit properties</source>
        <translation type="unfinished">Chỉnh sửa các thuộc tính</translation>
    </message>
    <message>
        <source>zfs Menu</source>
        <translation type="unfinished">zfs đơn</translation>
    </message>
    <message>
...
Are you sure you want to proceed?
    ...
    <message>
        ...
        <translation type="unfinished">Thêm Sức</translation>
    </message>
    <message>
        <source>Take a new snapshot</source>
        <translation type="unfinished">Có một bản chụp mới</translation>
    </message>
    <message>
...
Any snapshots created after this one will be deleted, along with any clone filesystems that depend on them.
        ...
        <translation type="unfinished">Hoạt động này không thể hoàn tác và sẽ gây ra tất cả các dữ liệu thêm vào sau khi ảnh chụp bị mất.
